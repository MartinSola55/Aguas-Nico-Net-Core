...
namespace AguasNico.Migrations
{
    ...
    [Migration("20231223211139_DispatchedProduct")]
    partial class DispatchedProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AguasNico.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CUIT = "20123123127",
                            CreatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4690),
                            Debt = 1500m,
                            HasInvoice = true,
                            InvoiceType = 2,
                            IsActive = true,
                            ...
                            Phone = "3404123123",
                            TaxCondition = 2,
                            UpdatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4690)
                        },
                        new
                        {
                            ID = 2L,
            ...
            modelBuilder.Entity("AguasNico.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4520),
                            IsActive = true,
                            Name = "Máquina frío/calor",
                            Price = 7800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4530)
                        },
                        new
                        {
                            ID = 2L,
                            Bottle = 2,
                            CreatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4530),
                            IsActive = true,
                            Name = "B12L",
                            Price = 1800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4530)
                        ...
                        new
                        {
                            ...
                            Name = "Soda 1/2",
                            Price = 600m,
                            UpdatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4540)
                        },
                        new
                        {
                            ID = 5L,
                            Bottle = 1,
                            CreatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4540),
                            IsActive = true,
                            Name = "B20L BAJADO",
                            Price = 2800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 18, 11, 38, 735, DateTimeKind.Utc).AddTicks(4540)
