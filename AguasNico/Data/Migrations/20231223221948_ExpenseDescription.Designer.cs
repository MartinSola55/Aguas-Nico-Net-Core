...
namespace AguasNico.Migrations
{
    ...
    [Migration("20231223221948_ExpenseDescription")]
            ...
            modelBuilder.Entity("AguasNico.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CUIT = "20123123127",
                            CreatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3470),
                            Debt = 1500m,
                            HasInvoice = true,
                            InvoiceType = 2,
                            IsActive = true,
                            ...
                            Phone = "3404123123",
                            TaxCondition = 2,
                            UpdatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3470)
                        },
                        new
                        {
                            ID = 2L,
                            Address = "A la vuelta de la cristalería",
                            CreatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3480),
                            Debt = 0m,
                            HasInvoice = false,
                            IsActive = true,
                            Name = "Agustín Bettig",
                            Phone = "3404123123",
                            UpdatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3480)
                        });
                });
            ...
            modelBuilder.Entity("AguasNico.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3360),
                            IsActive = true,
                            Name = "Máquina frío/calor",
                            Price = 7800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3370)
                        },
                        new
                        {
                            ID = 2L,
                            Bottle = 2,
                            CreatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3370),
                            IsActive = true,
                            Name = "B12L",
                            Price = 1800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3370)
                        ...
                        new
                        {
                            ...
                            Name = "B20L",
                            Price = 2400m,
                            UpdatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3380)
                        },
                        new
                        {
                            ID = 4L,
                            CreatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3380),
                            IsActive = true,
                            Name = "Soda 1/2",
                            Price = 600m,
                            UpdatedAt = new DateTime(2023, 12, 23, 19, 19, 48, 107, DateTimeKind.Utc).AddTicks(3380)
