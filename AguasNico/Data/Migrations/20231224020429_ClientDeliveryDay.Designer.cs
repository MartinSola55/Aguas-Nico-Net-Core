...
namespace AguasNico.Migrations
{
    ...
    [Migration("20231224020429_ClientDeliveryDay")]
    partial class ClientDeliveryDay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AguasNico.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CUIT = "20123123127",
                            CreatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(2060),
                            Debt = 1500m,
                            HasInvoice = true,
                            InvoiceType = 2,
                            IsActive = true,
                            ...
                            Phone = "3404123123",
                            TaxCondition = 2,
                            UpdatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(2060)
                        },
                        new
                        {
                            ID = 2L,
            ...
            modelBuilder.Entity("AguasNico.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1940),
                            IsActive = true,
                            Name = "Máquina frío/calor",
                            Price = 7800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1950)
                        },
                        new
                        {
                            ID = 2L,
                            Bottle = 2,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1950),
                            IsActive = true,
                            Name = "B12L",
                            Price = 1800m,
                            UpdatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1950)
                        ...
                        {
                            ID = 4L,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1970),
                            IsActive = true,
                            Name = "Soda 1/2",
                            Price = 600m,
                            UpdatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1970)
                        },
                        new
                        {
                            ID = 5L,
                        ...
                        {
                            ID = 8L,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1980),
                            IsActive = true,
                            Name = "MAQUINA SIN CARGO",
                            Price = 0m,
                            UpdatedAt = new DateTime(2023, 12, 23, 23, 4, 29, 36, DateTimeKind.Utc).AddTicks(1980)
                        },
                        new
                        {
                            ID = 9L,
